          ...
          {(activeTab === 'both' || activeTab === 'front') && (
            <g transform={activeTab === 'front' ? 'translate(50, 0)' : 'translate(0, 0)'}>
              ...
              <path
                ...
                onMouseEnter={() => setHoveredMuscle(lang === 'zh' ? '斜方肌上束' : 'Upper Traps')}
              ...
              <path
                ...
                onMouseEnter={() => setHoveredMuscle(lang === 'zh' ? '三角肌前束' : 'Anterior Delts')}
                onMouseLeave={() => setHoveredMuscle(null)}
              />
              <path
              ...
              <path
                ...
                onMouseEnter={() => setHoveredMuscle(lang === 'zh' ? '三角肌中束' : 'Lateral Delts')}
                onMouseLeave={() => setHoveredMuscle(null)}
              />
              <path
              ...
              <path
                ...
                onMouseEnter={() => setHoveredMuscle(lang === 'zh' ? '上胸 (锁骨头)' : 'Clavicular Pectorals (Upper Chest)')}
                onMouseLeave={() => setHoveredMuscle(null)}
              />
              <path
              ...
              <path
                ...
                onMouseEnter={() => setHoveredMuscle(lang === 'zh' ? '胸大肌中下部' : 'Sternal Pectorals (Mid/Lower Chest)')}
                onMouseLeave={() => setHoveredMuscle(null)}
              />
              <path
              ...
              <path
                ...
                onMouseEnter={() => setHoveredMuscle(lang === 'zh' ? '肱二头肌' : 'Biceps Brachii')}
                onMouseLeave={() => setHoveredMuscle(null)}
              />
              <path
              ...
              <path
                ...
                onMouseEnter={() => setHoveredMuscle(lang === 'zh' ? '前臂屈肌群' : 'Forearm Flexors')}
                onMouseLeave={() => setHoveredMuscle(null)}
              />
              <path
              ...
              <path
                ...
                onMouseEnter={() => setHoveredMuscle(lang === 'zh' ? '前臂伸肌群' : 'Forearm Extensors')}
                onMouseLeave={() => setHoveredMuscle(null)}
              />
              <path
              ...
              <path
                ...
                onMouseEnter={() => setHoveredMuscle(lang === 'zh' ? '腹直肌' : 'Rectus Abdominis')}
                onMouseLeave={() => setHoveredMuscle(null)}
              />
              ...
              <path
                ...
                onMouseEnter={() => setHoveredMuscle(lang === 'zh' ? '腹斜肌' : 'Obliques')}
                onMouseLeave={() => setHoveredMuscle(null)}
              />
              <path
              ...
              <path
                ...
                onMouseEnter={() => setHoveredMuscle(lang === 'zh' ? '股四头肌' : 'Quadriceps')}
                onMouseLeave={() => setHoveredMuscle(null)}
              />
              <path
              ...
              <path
                ...
                onMouseEnter={() => setHoveredMuscle(lang === 'zh' ? '内收肌群' : 'Adductors')}
                onMouseLeave={() => setHoveredMuscle(null)}
              />
              ...
              <path
                ...
                onMouseEnter={() => setHoveredMuscle(lang === 'zh' ? '小腿' : 'Calves')}
                onMouseLeave={() => setHoveredMuscle(null)}
              />
              <path
          ...
          {(activeTab === 'both' || activeTab === 'back') && (
            <g transform={activeTab === 'back' ? 'translate(50, 0)' : 'translate(105, 0)'}>
              ...
              <path
                ...
                onMouseEnter={() => setHoveredMuscle(lang === 'zh' ? '三角肌后束' : 'Posterior Delts')}
                onMouseLeave={() => setHoveredMuscle(null)}
              />
              <path
              ...
              <path
                ...
                onMouseEnter={() => setHoveredMuscle(lang === 'zh' ? '肱三头肌 (长头)' : 'Triceps (Long Head)')}
                onMouseLeave={() => setHoveredMuscle(null)}
              />
              <path
              ...
              <path
                ...
                onMouseEnter={() => setHoveredMuscle(lang === 'zh' ? '肱三头肌 (外侧头)' : 'Triceps (Lateral Head)')}
                onMouseLeave={() => setHoveredMuscle(null)}
              />
              <path
              ...
              <path
                ...
                onMouseEnter={() => setHoveredMuscle(lang === 'zh' ? '菱形肌 & 斜方肌中束' : 'Rhomboids & Mid Traps')}
                onMouseLeave={() => setHoveredMuscle(null)}
              />
              ...
              <path
                ...
                {...getMuscleStyle('lats')}
                onMouseEnter={() => setHoveredMuscle(lang === 'zh' ? '背阔肌' : 'Latissimus Dorsi')}
                onMouseLeave={() => setHoveredMuscle(null)}
              />
              <path
              ...
              <path
                ...
                onMouseEnter={() => setHoveredMuscle(lang === 'zh' ? '竖脊肌 (下背)' : 'Erector Spinae (Lower Back)')}
                onMouseLeave={() => setHoveredMuscle(null)}
              />
              ...
              <path
                ...
                onMouseEnter={() => setHoveredMuscle(lang === 'zh' ? '臀大肌' : 'Gluteus Maximus')}
                onMouseLeave={() => setHoveredMuscle(null)}
              />
              <path
              ...
              <path
                ...
                onMouseEnter={() => setHoveredMuscle(lang === 'zh' ? '腘绳肌' : 'Hamstrings')}
                onMouseLeave={() => setHoveredMuscle(null)}
              />
              <path
              ...
              <path
                ...
                {...getMuscleStyle('calves')}
                onMouseEnter={() => setHoveredMuscle(lang === 'zh' ? '小腿腓肠肌' : 'Calves (Gastrocnemius)')}
                onMouseLeave={() => setHoveredMuscle(null)}
              />
              <path
        ...
        <div className="w-full mt-2 pt-2 border-t border-[#1a1a20] flex items-center justify-between text-[10px] text-zinc-400">
          <div className="flex items-center gap-3">
            ...
            <span className="flex items-center gap-1 font-semibold text-cyan-400">
              <span className="w-2 h-2 rounded-full bg-cyan-500 shadow-sm shadow-cyan-500/50 inline-block" /> {t.secondaryTarget}
            </span>
          </div>
